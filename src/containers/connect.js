...
var KiteConnect = function(params) {
	...
	self.session_expiry_hook = null;
  	...
  	var userAgent = "kiteconnectjs/3.0.0";

  	//return "kiteconnectjs/3.0.0" + packageInfo.version;
...
regular).
	...
	self.exitOrder = function (variety, order_id, params) {
		self.cancelOrder(variety, order_id, params);
	};
	...
	function _post(route, params, responseType, responseTransformer) {

		return request(route, "POST", params || {}, responseType, responseTransformer);
	}

	function _put(route, params, responseType, responseTransformer) {
		return request(route, "PUT", params || {}, responseType, responseTransformer);
	}

	function _delete(route, params, responseType, responseTransformer) {
		return request(route, "DELETE", params || {}, responseType, responseTransformer);
	}
