...
export default function(state = [], action) {
  ...
  switch(action.type) {
    ...
    var factor = parseInt(action.payload.y);
    ...
    if(parseInt(action.payload.y) >= 500){
     ...
     if(parseInt(action.payload.y) >= 1000){
     var downMaxDiff = 100;
    }
    else{
       var downMaxDiff = 50;
   ...
   // console.log('bonaaaaa');
    ...
    var diffBetweenLowBalckPointBuy = 0.005*factor;
            ...
            if(statelen ==1){
               ...
               if(parseInt(action.payload.y) > state[0].y){
               ...
               else if(parseInt(action.payload.y) < state[0].y){
                    action.payload.highest = state[0].y;
                    action.payload.lowest = parseInt(action.payload.y);
                    action.payload.sidecount = 0;
                ...
                if(action.payload.dir == "up"){
                    ...
                    action.payload.upPivotPointsArr = [parseInt(action.payload.y)]
                }

                if(action.payload.dir == "low"){
                    
                     action.payload.lowPivotPointsArr = [parseInt(action.payload.y)];
                }
            }
            ...
            if(statelen == 2 ){
                ...
                if(action.payload.dir == "up"){
                     ...
                     if(action.payload.upPivotPointsArr == undefined){
                        ...
                        action.payload.upPivotPointsArr =  action.payload.upPivotPointsArr.concat(parseInt(action.payload.y));
                     }
                }
                ...
                if(action.payload.dir == "low"){
                      if(action.payload.lowPivotPointsArr == undefined){
                        ...
                        action.payload.lowPivotPointsArr =  action.payload.lowPivotPointsArr.concat(parseInt(action.payload.y));
                      }
                }
              ...
              if(state[0].y > state[1].y){
                ...
                //lower than 1
                 ...
                 if(parseInt(action.payload.y) < state[1].y){
                       action.payload.highest = state[0].y;
                       action.payload.lowest =  parseInt(action.payload.y);
                       action.payload.sidecount = 0;
                       action.payload.pivotArray = [];
                ...
                // upper than 1
                 if(parseInt(action.payload.y) > state[1].y && parseInt(action.payload.y) >= state[0].y){

                    //condition to check inside here goes
                   

                    var diff = Math.abs(state[0].y - parseInt(action.payload.y));
                      ...
                      //inside sideways
                       ...
                       action.payload.sidecount = 1;
                        ...
                        if(action.payload.pivotArray == undefined){
                          ;
                                        action.payload.pivotArray = [parseInt(action.payload.y)];
                                  }
                                  else{
                                    ;
                                       action.payload.pivotArray =  action.payload.pivotArray.concat(parseInt(action.payload.y));
                                  }
                    }
                    else{
                      //outside sideways
                ...
                // upper than 1
                 if(parseInt(action.payload.y) > state[0].y && parseInt(action.payload.y) > state[1].y){
                    action.payload.highest = parseInt(action.payload.y);
                    action.payload.lowest = state[0].y;
                    action.payload.sidecount = 0;
                     action.payload.pivotArray = [];
                ...
                //between 0 and 1 
                  ...
                  if(parseInt(action.payload.y) > state[0].y && parseInt(action.payload.y) < state[1].y ){
                     ...
                     // 
                      ...
                      action.payload.lowest = parseInt(state[0].y);
                      action.payload.highest = state[1].y;
                      action.payload.sidecount = 1;
              ...
              /* if(parseInt(action.payload.y) > state[1].y && parseInt(action.payload.y) < state[0].y ){
               ...
               else if(parseInt(action.payload.y) == state[1].y && parseInt(action.payload.y) < state[0].y){
                    action.payload.highest = state[0].y;
                    action.payload.lowest = state[1].y;
                    action.payload.sidecount = 0;
               }
                else if(parseInt(action.payload.y) < state[1].y && state[1].y< state[0].y){
                    action.payload.highest = state[0].y;
                    action.payload.lowest =  parseInt(action.payload.y);
                    action.payload.sidecount = 0;
               }
               else if(parseInt(action.payload.y) > state[1].y && parseInt(action.payload.y) > state[0].y && state[0].y > state[1].y){
                    action.payload.highest = parseInt(action.payload.y);
                    action.payload.lowest = state[1].y;
                    action.payload.sidecount = 0;
               }
               ...
               if(parseInt(action.payload.y) > state[1].y && state[1].y > state[0].y ){
                   action.payload.lowest = state[0].y;
                   action.payload.highest = parseInt(action.payload.y);
                   action.payload.sidecount = 0;
               }
                    ...
                    var diff = state[1].y - parseInt(action.payload.y);
                    var sidewaysHeight =  Math.abs(state[0].y - state[1].y) ;
                    var diffHeightRatio = diff/sidewaysHeight;
                    var insideSideways = 0;
                ...
                if(state[statelen-1].upcount != undefined){
                 ...
                 if(state[statelen-1].sidewaysFormationDate != undefined){
                  ...
                  if(state[statelen-1].sidecount ==4){
                     ...
                     console.log('sideways formed at ' + state[statelen-1].date);
            ...
            /*  if(Math.abs(parseInt(action.payload.y) - state[statelen-1].y) > crudeBigDay){
                 //time to clear everything and loop for short and look respectivity
                 
                   if(parseInt(action.payload.y) > state[statelen-1].y && action.payload.crudeTradeManagement != "trailing"){
                      action.payload.bigDayTrade = 'short'; 
                      action.payload.bigDayTradePrice = parseInt(action.payload.y); 
                      action.payload.highest = parseInt(action.payload.y);                    
                   ...
                   else if(parseInt(action.payload.y) < state[statelen-1].y){
              ...
              if(state[statelen-1].trend == 'sideways'){
                    ...
                    if(action.payload.dir == "up" && parseInt(state[statelen-1].highest) < parseInt(parseInt(action.payload.y)) && state[statelen-1].retesthappen != 0 ){
                      //console.log('111');
                      ...
                      if(state[statelen-1].upblackextreme != undefined &&  state[statelen-1].upblackextreme != 0 ){
                            var diff = Math.abs(state[statelen-1].upblackextreme-parseInt(action.payload.y) );
                           
                           //
                        
                        if(diff <= retestDiff && state[statelen-1].ShortTradeInitiated != true && parseInt(state[statelen-1].UPblackpoint) < parseInt(parseInt(action.payload.y)) && parseInt(state[statelen-1].highest) < parseInt(action.payload.currentPrice)){
                            ...
                            if(priceDiff > minUpSellPriceDiff){
                                   ...
                                   ;
                                    ...
                                    action.payload.highest = state[statelen-1].highest;                    
                                    action.payload.lowest = parseInt(state[statelen-1].lowest);
                              ...
                              //  
                               ...
                               if(action.payload.prevY > state[statelen-1].highest){
                                    ...
                                    // ;
                                     ...
                                     action.payload.upblackextreme = parseInt(action.payload.y);
                                     action.payload.UPblackpoint = parseInt(action.payload.y);
                    ...
                    else if(action.payload.dir == "low" && state[statelen-1].lowest > parseInt(action.payload.y)){
                        //set this point as blackline to test 

                        
                       

                        if(state[statelen-1].Lowblackpoint != undefined &&  state[statelen-1].Lowblackpoint != 0 && parseInt(state[statelen-1].lowest) > parseInt(action.payload.currentPrice)){
                       
                                  var diff = Math.abs(state[statelen-1].Lowblackpoint-parseInt(action.payload.y) );
                              
                                  //console.log('11' + parseInt(action.payload.y));
                                 // var diffBetweenLowBalckPointBuy =  Math.abs(parseInt(action.payload.y)-);
                                
                                if(parseInt(state[statelen-1].Lowblackpoint) > parseInt(parseInt(action.payload.y) )&& (state[statelen-1].downretesthappen == undefined || state[statelen-1].downretesthappen == false)){
                                   ...
                                   // console.log('tin tina tin tin');
                                    if(diff >= downMaxDiff){
                                       ...
                                       console.log('cha cha cha' + parseInt(action.payload.y));
                           ...
                           /*   if( diff <= retestDiff && state[statelen-1].LongTradeInitiated != true){
                              ...
                              /* action.payload.highest = state[statelen-1].highest;                    
                               ...
                               //low black extreme lovely
                                ...
                                if(action.payload.lowblackextreme > parseInt(action.payload.y)){
                                     action.payload.lowblackextreme = parseInt(action.payload.y);
                                     action.payload.Lowblackpoint = action.payload.lowblackextreme;
                                }*/

                               /*if(Math.abs(parseInt(action.payload.y)-action.payload.lowest) >10){
                                  action.payload.lowblackextreme = parseInt(action.payload.y);
                                  action.payload.Lowblackpoint = action.payload.lowblackextreme;
                                  action.payload.lowblackindex = action.payload.lowblackextremeindex;
                               }*/
                            ...
                            // 
                          if( parseInt(action.payload.prevY ) < parseInt(state[statelen-1].lowest) && (state[statelen-1].Lowblackpoint == undefined || state[statelen-1].Lowblackpoint == 0)){
               ...
               if(state[statelen-1].UPblackpoint != undefined || state[statelen-1].Lowblackpoint != undefined){
                   ...
                   //now see if black line point is touched or not asap
                      if((state[statelen-1].UPblackpoint != undefined &&  state[statelen-1].UPblackpoint != 0) && state[statelen-1].trend == 'sideways' && action.payload.dir =="up"){
                          ...
                          var diff = Math.abs(state[statelen-1].UPblackpoint - parseInt(action.payload.y));
                         
                           // 

                           if((parseInt(state[statelen-1].UPblackpoint) <= parseInt(parseInt(action.payload.y) )&& diff <= dayRetestDiff) && state[statelen-1].trend == 'sideways' && state[statelen-1].ShortTradeInitiated != true && state[statelen-1].highest < action.payload.currentPrice){
                               //normal bpb short
                              // 
...
//solomon.murugan@wipro.com
              ...
              if(parseInt(state[statelen-1].highest )>= parseInt(parseInt(action.payload.y)) && parseInt(state[statelen-1].lowest) <= parseInt(parseInt(action.payload.y) )){
              ...
              else if(action.payload.dir == "up" && parseInt(parseInt(action.payload.y) )> parseInt(state[statelen-1].highest) && state[statelen-1].trend != 'sideways'  && (state[statelen-1].upcount == undefined || state[statelen-1].upcount ==0)){
                    //first time price breaks outside
                    //check the length of this breakout ..if it exceed normal length then time to empty sideways

                    //let breakoutlength =  Maths.abs(parseInt(action.payload.y) - state[statelen-1].y);
                   // 
                    ...
                    var diff = parseInt(action.payload.y) - state[statelen-1].highest ;
                   ...
                   /* if(sidewaysHeight <= 20){
              ...
              else if(action.payload.dir == "up" && parseInt(parseInt(action.payload.y)) > parseInt(state[statelen-1].highest)&& state[state.length-1].sidecount < 4 && state[statelen-1].upcount == 1 ){
                    ...
                    //let prevswinglength = state[statelen-1].highest - state[statelen-1].lowest;
                     ...
                     var tradeDir = parseInt(action.payload.y) - state[statelen-1].upblackextreme;
                     var sidewaysHeight =   state[statelen-1].highest -  state[statelen-1].lowest ;
                     var diff = parseInt(action.payload.y) - state[statelen-1].highest ;
                     var diffHeightRatio = diff/sidewaysHeight;
                     var check = 0;
              ...
              else if(action.payload.dir == "low" && parseInt(parseInt(action.payload.y)) > parseInt(state[statelen-1].highest) && state[statelen-1].trend != 'sideways' ){
                    //time to empty the swing and create a new swing 

                    action.payload.highest = state[statelen-1].y;                    
                    action.payload.lowest = parseInt(state[statelen-2].y);
              ...
              else if(action.payload.dir == "up" && parseInt(parseInt(action.payload.y)) < parseInt(state[statelen-1].lowest )&& state[statelen-1].trend != 'sideways'){
                    //time to empty the swing and create a new swing
              ...
              else if(action.payload.dir == "low" && parseInt(parseInt(action.payload.y))< parseInt(state[statelen-1].lowest) && (state[statelen-1].downcount == undefined || state[statelen-1].downcount ==0)  && state[state.length-1].sidecount < 4){
                   
                    var diff = state[statelen-1].lowest - parseInt(action.payload.y);
                    var sidewaysHeight =   state[statelen-1].highest -  state[statelen-1].lowest ;
                    var diffHeightRatio = diff/sidewaysHeight;
                    var check = 0;
                   ...
                   /* if(sidewaysHeight <= sidewaysCheckMinHeight){
                    ...
                    if( check == 0 && (action.payload.downcount == 0 || action.payload.downcount == undefined)){
                       ...
                       action.payload.upcount = 0; 
                       action.payload.highest = state[statelen-1].y;                    
                       action.payload.lowest = parseInt(parseInt(action.payload.y));
                       action.payload.upblackextreme = 0;
                       action.payload.lowblackextreme = 0;
                       action.payload.UPblackpoint = 0;
                       action.payload.Lowblackpoint = 0; 
                      ...
                      /* if(Math.abs(parseInt(action.payload.y)-action.payload.lowest) >= 4){
               ...
               else if(action.payload.dir == "low" && parseInt(parseInt(action.payload.y)) < parseInt(state[statelen-1].Lowblackpoint) && (state[statelen-1].downretesthappen == true)){
              //now time to clear sideways context and make a new trend all together ShortTradeInitiated LongTradeInitiated
                ...
                // console.log(state[statelen-1].Lowblackpoint - parseInt(action.payload.y) );

                if(state[statelen-1].Lowblackpoint - parseInt(action.payload.y) > retestDiff){
                       //  
                 ...
                 else if(action.payload.dir == "up" && parseInt(parseInt(action.payload.y)) > parseInt(state[statelen-1].UPblackpoint )&& (state[statelen-1].retesthappen == true)){
              //now time to clear sideways context and make a new trend all together
                 
                // console.log(' up diff is');
                 //console.log(state[statelen-1].UPblackpoint - parseInt(action.payload.y) );
                // console.log('x');
                  ...
                  if(parseInt(action.payload.y) - state[statelen-1].UPblackpoint> retestDiff){
                     //  
                  ...
                  else if(action.payload.dir == "low" && parseInt(parseInt(action.payload.y)) < parseInt(state[statelen-1].lowest) && state[state.length-1].sidecount < 4 && state[statelen-1].downcount == 1 ){
                    //time to empty the swing and create a new swing 
                  ...
                  if(action.payload.dir == "low" ){ 
                          ...
                          if(parseInt(parseInt(action.payload.y)) >= parseInt(state[statelen-1].highest) && action.payload.upcount ==1 && state[statelen-1].trend != 'sideways'){
                            //uptredn started
                          // console.log('uptrend started');
                           ...
                           action.payload.highest = parseInt(action.payload.y);
                           action.payload.lowest = parseInt(state[state.length-1].y);
                           action.payload.upcount = 0;
                           action.payload.downcount = 0;   
                           ...
                           else if(state[statelen-1].highest >= parseInt(action.payload.y) && state[statelen-1].lowest <= parseInt(action.payload.y)){
                                //back in sideways
                       ...
                       if(parseInt(parseInt(action.payload.y)) <= parseInt(state[statelen-1].lowest )&& action.payload.downcount ==1 && state[statelen-1].trend != 'sideways'){
                            //uptredn started
